    ...
    <div class="container">
        <div class="services-grid">
            <div class="service-box">
                ...
                <h3>Schnelle Hilfe im Notfall</h3>
                <p>Unser 24/7-Notdienst ist rund um die Uhr für Sie da – auch an Wochenenden und Feiertagen. Bei Stromausfall oder defekten Anlagen sind wir schnell vor Ort.</p>
            </div>
            ...
            <div class="service-box">
                ...
                <h3>Fachgerechte Installation</h3>
                <p>Von der Neuinstallation bis zur Modernisierung – wir setzen alle Elektroarbeiten sauber, sicher und nach aktuellen Normen um.</p>
            </div>
            ...
            <div class="service-box">
                ...
                <h3>Garantierte Termine</h3>
                <p>Wir halten, was wir versprechen: Pünktliche Anfahrt, transparente Preise und zuverlässige Abwicklung – ohne versteckte Kosten.</p>
            </div>
        </div>
